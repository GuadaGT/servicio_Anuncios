...
let UsuariosService = class UsuariosService {
    ...
    async create(crearUsuarioDto) {
        const otroUsuario = await this.userModel.findOne({ username: crearUsuarioDto.username }).exec();
        if (otroUsuario) {
            throw new common_1.BadRequestException({ message: 'Ya existe un usuario con ese nombre.' });
        }
...
exports.UsuariosService = UsuariosService = __decorate([
    ...
    __param(0, (0, mongoose_2.InjectModel)(usuario_schema_1.User.name)),
